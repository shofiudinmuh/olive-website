            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group row mt-2">
                        <label for="nama_staff" class="col-lg-2 col-lg-offset-1 control-label">Nama Staff</label>
                        <div class="col-lg-6">
                    ...
                    <div class="form-group row">
                        <label for="id_kategori" class="col-lg-2 col-lg-offset-1 control-label">Jabatan</label>
                        <div class="col-lg-6">
